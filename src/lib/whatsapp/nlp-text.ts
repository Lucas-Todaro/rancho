export function normalizeRanchoText(value: string) {
  return value
    ...
    .replace(/\b(?:estoqe|estoqui|estoq)\b/g, "estoque")
    .replace(/\b(?:qunto|qnt)\b/g, "quanto")
    .replace(/\biten\b/g, "item")
    .replace(/\bacabano\b/g, "acabando")
    .replace(/\bminral\b/g, "mineral")
    .replace(/\bvermefugo\b/g, "vermifugo")
    .replace(/\b(?:baxo|baicho)\b/g, "baixo")

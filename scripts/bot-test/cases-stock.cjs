module.exports = function loadBotTestSection(context) {
  with (context) {
    const inventoryHumanParserTests = [
      ...
      { phrase: "comprei 70kg de arroz", expected: { tipo: "ESTOQUE_ENTRADA", exactTipo: true, compra: true, item: "arroz", quantidade: 70, unidade: "kg", itemUnresolved: true, itemFound: false, motivoIncludes: "item_nao_encontrado", missing: ["valor"] } },
      { phrase: "comprei arroz 70kg", expected: { tipo: "ESTOQUE_ENTRADA", exactTipo: true, compra: true, item: "arroz", quantidade: 70, unidade: "kg", itemUnresolved: true, itemFound: false, missing: ["valor"] } },
      { phrase: "compra de 70kg de arroz", expected: { tipo: "ESTOQUE_ENTRADA", exactTipo: true, compra: true, item: "arroz", quantidade: 70, unidade: "kg", itemUnresolved: true, itemFound: false, missing: ["valor"] } },
      ...
      { phrase: "comprei 70 kilos de arroz", expected: { tipo: "ESTOQUE_ENTRADA", exactTipo: true, compra: true, item: "arroz", quantidade: 70, unidade: "kg", itemUnresolved: true, itemFound: false, missing: ["valor"] } },
      { phrase: "comprei 70k de arroz", expected: { tipo: "ESTOQUE_ENTRADA", exactTipo: true, compra: true, item: "arroz", quantidade: 70, unidade: "kg", itemUnresolved: true, itemFound: false, missing: ["valor"] } },
      { phrase: "comprei arroz 70k", expected: { tipo: "ESTOQUE_ENTRADA", exactTipo: true, compra: true, item: "arroz", quantidade: 70, unidade: "kg", itemUnresolved: true, itemFound: false, missing: ["valor"] } },
      ...
      { phrase: "comprei 5 doses de aftoza", expected: { tipo: "ESTOQUE_ENTRADA", exactTipo: true, compra: true, item: "Aftosa", quantidade: 5, unidade: "dose", itemFound: true, missing: ["valor"] } },

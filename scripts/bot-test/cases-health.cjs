module.exports = function loadBotTestSection(context) {
  with (context) {
    const eventHumanParserTests = [
      ...
      eventParser("001 pariu uma femea hoje", { tipo: "PARTO", exactTipo: true, animal: "001", data_referencia: "hoje", parto_cria_cadastro: true, cria_sexo: "femea", cria_categoria: "bezerro", missing: ["cria_codigo"] }),
      ...
      eventParser("Mimosa pariu uma bezerra ontem", { tipo: "PARTO", exactTipo: true, animal: "B-001", data_referencia: "ontem", parto_cria_cadastro: true, cria_sexo: "femea", cria_categoria: "bezerro", missing: ["cria_codigo"] }),
      eventParser("B-001 pariu cria codigo C-123 femea hoje", { tipo: "PARTO", exactTipo: true, animal: "B-001", data_referencia: "hoje", parto_cria_cadastro: true, cria_sexo: "femea", cria_categoria: "bezerro", cria_codigo: "C-123", noMissing: true }),
      ...
      eventParser("nao foi ontem", { tipo: "PARTO", exactTipo: true, animal: "B-001", data_referencia: "ontem" }, { pending: () => pendingFrom("Mimosa pariu hoje") }),

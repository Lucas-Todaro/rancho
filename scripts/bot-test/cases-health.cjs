module.exports = function loadBotTestSection(context) {
  with (context) {
    const eventHumanParserTests = [
      ...
      { module: "eventos-relatorios", phrase: "quais foram os partos recentes", expected: { tipo: "CONSULTA_REGISTROS_HOJE", exactTipo: true, data_referencia: "recentes", consulta_registros: "eventos", evento_tipo: "parto" } },
      { module: "eventos-relatorios", phrase: "partos recentes", expected: { tipo: "CONSULTA_REGISTROS_HOJE", exactTipo: true, data_referencia: "recentes", consulta_registros: "eventos", evento_tipo: "parto" } },
      { module: "eventos-relatorios", phrase: "ultimos partos", expected: { tipo: "CONSULTA_REGISTROS_HOJE", exactTipo: true, data_referencia: "recentes", consulta_registros: "eventos", evento_tipo: "parto" } },
      { module: "eventos-relatorios", phrase: "quem pariu recentemente", expected: { tipo: "CONSULTA_REGISTROS_HOJE", exactTipo: true, data_referencia: "recentes", consulta_registros: "eventos", evento_tipo: "parto" } },

module.exports = function loadBotTestSection(context) {
  with (context) {
    const eventHumanParserTests = [
      ...
      eventParser("protocolo de inseminacao da 19", { tipo: "ATUALIZACAO_ANIMAL", exactTipo: true, animal: "19", campo_alterado: "observacoes", registro_evento_animal: true, evento_tipo: "reprodutivo", evento_reprodutivo_tipo: "inseminacao" }),

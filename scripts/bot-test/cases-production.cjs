module.exports = function loadBotTestSection(context) {
  with (context) {
    ...
    const extraTests = [
      ...
      { phrase: "vendi 40L de leite por 200 reais", expected: { tipo: "ESTOQUE_SAIDA", exactTipo: true, venda: true, item: "Leite Cru", quantidade: 40, unidade: "L", valor: 200, motivoIncludes: "estoque+receita" } },
    ...
    const herdLotParserTests = [
      ...
      { module: "rebanho-lotes", phrase: "dados das vagas", expected: { tipo: "CONSULTA_REBANHO", exactTipo: true, categoria: "vaca", modo: "resumo", consulta: true, noMissing: true } },

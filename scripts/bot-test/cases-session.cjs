module.exports = function loadBotTestSection(context) {
  with (context) {
    const botConversationTests = [
      ...
      {
        name: "quick replies de confirmacao aparecem e Confirmar funciona como 1",
        phone: BOT_TEST_ADMIN_PHONE,
        expectNoBusinessWrites: true,
        messages: [
          {
            text: "B-002 deu 31 litros para venda",
            expected: {
              intent: "PRODUCAO_LEITE",
              estadoNovo: "aguardando_confirmacao",
              quickReplies: ["Confirmar", "Corrigir", "Cancelar"]
            }
          },
          {
            text: "Confirmar",
      ...
      {
        name: "Corrigir e Cancelar por botao preservam fluxo textual",
        phone: BOT_TEST_ADMIN_PHONE,
        expectNoBusinessWrites: true,
        messages: [
          {
      ...
      {
        name: "pergunta sexo da cria tem quick replies e Femea funciona",
        phone: BOT_TEST_ADMIN_PHONE,
        expectNoBusinessWrites: true,
        messages: [
          {
            text: "B-001 pariu cria codigo C-009 hoje",
            expected: {
              intent: "PARTO",
              estadoNovo: "aguardando_dado",
              quickReplies: ["Macho", "Femea", "Cancelar"],
              responseIncludes: "cria nasceu"
            }
          },
          {
            text: "Fêmea",
      ...
      {
        name: "Gerar codigo por botao funciona como 2 no parto com cria",
        phone: BOT_TEST_ADMIN_PHONE,
        expectNoBusinessWrites: true,
        messages: [
          {
            text: "B-001 pariu femea hoje",
            expected: {
              intent: "PARTO",
              estadoNovo: "aguardando_dado",
              quickReplies: ["Informar código", "Gerar código", "Cancelar"]
            }
          },
          {
            text: "Gerar código",

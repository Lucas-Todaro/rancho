module.exports = function loadBotTestSection(context) {
  with (context) {
    const animalConsultationAndUpdateTests = [
      ...
      { phrase: "dados da vaca", expected: { tipo: "CONSULTA_ANIMAL", exactTipo: true, consulta: true, missing: ["animal_codigo"] } },
      { phrase: "como que ta a vaca 19", expected: { tipo: "CONSULTA_ANIMAL", exactTipo: true, animal: "19", consulta: true } },
      { phrase: "como esta a vaca 19?", expected: { tipo: "CONSULTA_ANIMAL", exactTipo: true, animal: "19", consulta: true } },
      { phrase: "dados da Mimosa", expected: { tipo: "CONSULTA_ANIMAL", exactTipo: true, animal: "B-001", consulta: true } },
